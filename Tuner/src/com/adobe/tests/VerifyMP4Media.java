...
public class VerifyMP4Media extends TestBase {
	...
	public void selectMediaType() throws InterruptedException {
	    ...
	    select.selectByVisibleText("MP4 - BigBuckBunny");
	    Thread.sleep(5000);
	...
	public void verifyPlayerLoading() throws InterruptedException {
		...
		/*Boolean status = (Boolean) js.executeScript("arguments[0].playing;", video);
		System.out.println(status);*/
		playerActions.pause();
		System.out.println("Video paused");
		Assert.assertTrue(playerActions.isPaused());
		//if((boolean) (js .executeScript("document.getElementsByTagName(\"video\").playing")));
	...
	public void verifyPlayerVolume() throws InterruptedException {
		...
		playerActions.setVolume("0.4");
		playerActions.setVolume("0.2");
