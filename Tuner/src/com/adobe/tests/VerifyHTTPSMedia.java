...
public class VerifyHTTPSMedia extends TestBase {
	...
	public void selectMediaType() throws InterruptedException {
		...
		driver.get("https://ptdemos.com/html5/internal/1_2/testContent/machine/machine.m3u8 ");
	    ...
	    select.selectByVisibleText("HLS - Closed Captions");
	    Thread.sleep(5000);
