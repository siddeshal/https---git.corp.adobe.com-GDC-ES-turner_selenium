...
public class VerifyTurnerMedia extends TestBase {
	...
	public void selectMediaType() throws InterruptedException {
		...
		driver.get("http://penupati-wx-1.corp.adobe.com:8887/turner.html");
		...
		playerActions.play();
		Select select = new Select(driver.findElement(By.xpath("//*[@id='provider']")));
	    select.selectByVisibleText("Turner Medium");
	    Thread.sleep(5000);
